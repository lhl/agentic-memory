...
This document is a synthesis/comparison of **academic + industry** work on long‑term memory for LLM agents (benchmarks, architectures, attacks, and surveys), intended to drive design decisions for `shisad` (implementation reference: `/home/lhl/github/shisa-ai/shisad/docs/PLAN-longterm-memory.md`).
...
`shisad`’s `/home/lhl/github/shisa-ai/shisad/docs/PLAN-longterm-memory.md` already aligns strongly with the best “2026‑shaped” ideas:
